...
###########################
# param
trait_file = 'clean_trait_data.txt'
traits_num = 6
pos_file = 'extract_snp.130samples.tetraploid.genotype'
###########################
data <- read.GWASpoly(ploidy=4,pheno.file=trait_file,geno.file=pos_file,format="ACGT",n.traits=traits_num7,delim="\t")
...
trait_name <- trait_name[2:traits_num]
